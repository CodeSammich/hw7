...
void my_main( int polygons ) {
  ...
  for (i=0;i<lastop;i++) {  
    ...
    case SPHERE:
      add_sphere( tmp, op[i].op.sphere.d[0], op[i].op.sphere.d[1], op[i].op.sphere.d[2], op[i].op.sphere.r, 15);
    ...
    case TORUS:
      add_torus( tmp, op[i].op.torus.d[0], op[i].op.torus.d[1], op[i].op.torus.d[2], op[i].op.torus.r0, op[i].op.torus.r1, 15);
